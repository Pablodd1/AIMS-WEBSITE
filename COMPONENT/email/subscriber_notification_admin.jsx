        ...
        <EmailLayout>
            <Container style={container}>
                ...
                <Text style={subheading}>
                    A new user has just subscribed to the <strong>AI Medical Scribe</strong> web app.
                </Text>

                <Hr style={divider} />

                <Text style={label}>👤 Subscriber Details:</Text>
                <Text><strong>Name:</strong> {userName || 'N/A'}</Text>
                <Text><strong>Email:</strong> {email}</Text>

                <Hr style={divider} />

                <Text style={footer}>
                    You can view full subscriber data and manage accounts in the admin dashboard.
                </Text>
            </Container>
        </EmailLayout>
    );
