        ...
        <EmailLayout>
            <Section style={{ marginBottom: "16px" }}>
                ...
                <Text style={{ fontSize: "14px", color: "#555" }}>
                    A new user has submitted the “Get Started” form. Below are the submitted details:
                </Text>
            </Section>
            ...
            <Section>
                <table style={{ width: "100%", borderCollapse: "collapse" }}>
                    <tbody>
                        ...
                        <tr><td><strong>Billing Plan:</strong></td><td>{billing}</td></tr>
                        <tr><td><strong>Subscribed to Updates:</strong></td><td>{subscription ? "Yes" : "No"}</td></tr>
                        <tr><td><strong>Have Medical Scribe Experience:</strong></td><td>{HaveMS}</td></tr>
                        <tr><td><strong>Experienced User:</strong></td><td>{ExperiancedUser}</td></tr>
                        <tr><td><strong>Referral:</strong></td><td>{referal}</td></tr>
                    </tbody>
                </table>
            </Section>
