...
export const SupportRequestEmailUser = ({ userEmail, userPhone, userClinic, userMessage }) => {
    return (
        <EmailLayout>
            <Container style={container}>
                <Section style={headerSection}>
                    <Text style={heading}>Thank You for Reaching Out to Us! 🙏</Text>
                    <Text style={subHeading}>We have received your support request and will get back to you as soon as possible.</Text>
                </Section>
                ...
                <Section style={contentSection}>
                    ...
                    <Text style={paragraph}>
                        If you have any further questions or need immediate assistance, feel free to reply to this email.
                    </Text>

                    <Link href="mailto:support@aimedicalscriber.com" style={ctaLink}>Contact Support</Link>
                </Section>
