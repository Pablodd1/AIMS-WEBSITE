    ...
    return (
        <EmailLayout>
            <Section style={{ textAlign: "center" }}>
                <Text style={{ fontSize: "20px", fontWeight: "600", marginBottom: "8px" }}>
                    Thank you, {firstName}!
                </Text>
            ...
            <Section>
                ...
                <ul style={{ paddingLeft: "16px", color: "#555", fontSize: "14px" }}>
                    ...
                    <li><strong>Billing Type:</strong> {billing}</li>
                </ul>
            </Section>
            ...
            <Text style={{ fontSize: "12px", color: "#777", textAlign: "center", marginTop: "24px" }}>
                You’re receiving this email because you submitted a request at AI Medical Scribe.
            </Text>
        </EmailLayout>
    );
}
