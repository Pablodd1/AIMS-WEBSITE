      ...
      >
        ...
        >
          <table
            role="presentation"
            width="100%"
            style={{ maxWidth: "1200px", margin: "15px auto 0", padding: 0 }}
          >
            {/* <tr>
            ...
            <tr>
              <td align="center">
                <table
                  role="presentation"
                  width="100%"
                  style={{ maxWidth: "1024px", marginTop: "30px", padding: 0 }}
                >
                  <tr>
                    <td
                      style={{
                    ...
                    >
                      <Link
                        href={`${process.env.BASE_URL}/technology`}
                        style={{
                          fontSize: "14px",
                          color: "#333",
                          textDecoration: "none",
                      ...
                      <Link
                        href={`${process.env.BASE_URL}/about-us`}
                        style={{
                          fontSize: "14px",
                          color: "#333",
                          textDecoration: "none",
