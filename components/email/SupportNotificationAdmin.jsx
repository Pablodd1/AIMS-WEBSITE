...
export const SupportRequestEmailAdmin = ({
  userEmail,
  userPhone,
  userClinic,
  userMessage,
      ...
      <Container style={container}>
        <Section style={headerSection}>
          ...
          <Text style={subHeading}>
            A new support request has been submitted by a user. Please review
            the details below and respond promptly.
          </Text>
        </Section>
        ...
        <Section style={contentSection}>
          ...
          <Text style={paragraph}>
            To follow up with the user, simply reply to their message or reach
            them via email.
          </Text>

          <Link href={`mailto:${userEmail}`} style={ctaLink}>
            Reply to User
          </Link>
        </Section>
