...
const videos = [
  ...
  },
  {
    ...
    description:
      "Did you know? 🤔 Doctors spend nearly as much time on medical documentation as they do on patient care. For every hour...",
  ...
  },
  {
    ...
    description:
      "Ditch the Charts, Doc! AI Scribes Take On Busy Hospitals 🩺⏰ Stressed doctor swamped with paperwork? Imagine an AI ...",
      ...
      {videos.map((video, index) => (
        <div
          ...
          className={`h-full flex flex-col justify-center ${
            index === 0
              ? "row-span-1 sm:row-span-2 md:row-span-2 col-span-2 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              : "row-span-1"
          }`}
        >
          <iframe
          ...
          <div className="video-info">
            ...
            <p className="text-gray-600 font-sans">
              ...
              <Link
                ...
                target="_blank"
                className={
                  "m-1 px-3 text-primary font-bold uppercase text-xs rounded-md hover:underline "
                }
              >
                Read More
              </Link>
